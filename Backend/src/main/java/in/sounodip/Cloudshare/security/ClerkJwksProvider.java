...
public class ClerkJwksProvider {
    ...
    public PublicKey getPublicKey(String kid) throws Exception{ //kid=key id
    ...
    private void refreshKeys() throws Exception{
        ...
        for(JsonNode keyNode:keys){
            String kid = keyNode.get("kid").asText(); //kid=key id
            String kty = keyNode.get("kty").asText(); //kty=key type
            String alg = keyNode.get("alg").asText(); //alg=algorithm
