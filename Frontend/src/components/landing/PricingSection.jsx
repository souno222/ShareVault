                ...
                <div className="mt-16 space-y-12 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-8">
                    {pricingPlans.map((plan,index) => (
                        <div key={index} className={`flex flex-col rounded-lg shadow-lg overflow-hidden ${plan.highlighted?'border-2 border-purple-500 transform scale-105':'border border-gray-200'}`}>
                            <div className={`px-6 py-4 bg-white ${plan.highlighted ?'bg-gradient-to-br from-purple-50 to-white':''}`}>
                            ...
                            <div className="flex-1 flex flex-col justify-between px-6 pt-6 pb-8 bg-gray-50 space-y-6">
                                    ...
                                    <div className="rounded-md shadow">
                                            <button 
                                                onClick={openSignUp}
                                                className={`w-full flex items-center justify-center px-5 py-3 border text-base font-medium rounded-md transition-colors duration-200 ${plan.highlighted ? 'text-white bg-blue-800 border-blue-800 hover:bg-blue-600 hover:border-blue-600' : 'text-purple-600 bg-white border-purple-500 hover:bg-purple-50 hover:text-purple-700 hover:border-purple-700'}`} >
                                                {plan.cta}
                                            </button>
                                    </div>
                            </div>
